                   ...
                   <h5 class="form_hd">Please Enter Below Details To Edit Certificate: </h5>
                    ...
                    <?php
                        ...
                        if (isset($_GET['edit']))
                        {
                            ...
                            $result = mysqli_query($con,"SELECT mem_association,mem_company,mem_name,mem_date,mem_number,mem_mail,mem_filename FROM newcertificate1 WHERE mem_id = '$id'");
                        }
                         while (@$row = mysqli_fetch_array($result))
                        {
                                echo "<tr>
                                        <form action=edit.php?update=$id method=POST>";
                               echo "<td><span class=myspan>ASSOCIATION NAME</span><input type=text class=myfield name=mem_association1 value='".$row['mem_association']."'></td><br>";
                        ...
                        $id1 = $_GET['update'];
                       	if(isset($_POST['mem_association1'])&&isset($_POST['mem_company1']) && isset($_POST['mem_name1']) && isset($_POST['mem_date1']) && isset($_POST['mem_number1']) && isset($_POST['mem_mail1'])&& isset($_POST['mem_name1']))
                    	{	
                    		...
                    		$email=$_POST['mem_mail1'];
                    		 $association=$_POST['mem_association1'];
                    		
                           
                          
                            
                            $sql=mysqli_query($con,"UPDATE newcertificate1 SET mem_association='$association',mem_company='$company',mem_name='$name',mem_date='$date',mem_number='$number',mem_mail='$email' where mem_id='$id1'");
                        }
...
$pdf->Cell(500+450,460,$Cname,0,0,'C');
